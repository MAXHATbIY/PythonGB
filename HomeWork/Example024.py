...
n = int(input("Введите количество кустов от 3 до 100: "))
berry_num = [random.randint(50, 80) for i in range(n)]
print(*berry_num)
...
for i in range(len(berry_num)):
    ...
    max_berry = total_berries if total_berries > max_berry else max_berry
print(max_berry)
